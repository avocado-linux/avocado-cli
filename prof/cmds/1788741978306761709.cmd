...
# Write stamp file
mkdir -p "$AVOCADO_PREFIX/.stamps/$(dirname 'runtime/dev/build.stamp')"
cat > "$AVOCADO_PREFIX/.stamps/runtime/dev/build.stamp" << 'STAMP_EOF'
{
  "version": 4,
  "command": "build",
  "component": "runtime",
  "component_name": "dev",
  "target": "qemux86-64",
  "timestamp": "2026-09-07T00:46:18.241876200Z",
  "success": true,
  "inputs": {
    "config_hash": "sha256:66dc22086588eeb3917b420c8eda4a1e8c1331a30266bbe6200ed55607dc3652"
  },
  "outputs": {},
