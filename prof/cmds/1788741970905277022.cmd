...
echo -n "__outputs__:::"; for _f in "$AVOCADO_PREFIX/output/extensions/avocado-ext-dev-"*.raw "$AVOCADO_PREFIX/output/extensions/avocado-ext-dev-"*.kab; do [ -e "$_f" ] && printf '%s ' "$(basename "$_f")"; done; echo