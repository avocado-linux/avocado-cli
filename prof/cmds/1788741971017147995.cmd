...
echo -n "__outputs__:::"; for _f in "$AVOCADO_PREFIX/output/extensions/avocado-bsp-qemux86-64-"*.raw "$AVOCADO_PREFIX/output/extensions/avocado-bsp-qemux86-64-"*.kab; do [ -e "$_f" ] && printf '%s ' "$(basename "$_f")"; done; echo