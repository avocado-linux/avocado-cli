...
set -euo pipefail
DEST="$AVOCADO_PREFIX/runtimes/dev/var-staging/lib/avocado/tuf-staging"
mkdir -p "$DEST/delegations"
cp /opt/src/.tuf-staging-tmp/targets.json "$DEST/targets.json"
cp /opt/src/.tuf-staging-tmp/delegations/runtime-b837d0f7-2f43-41af-8366-4ece9e65b12f.json \
   "$DEST/delegations/runtime-b837d0f7-2f43-41af-8366-4ece9e65b12f.json"
