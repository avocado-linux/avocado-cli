...
echo -n "__outputs__:::"; for _f in "$AVOCADO_PREFIX/output/extensions/avocado-ext-sshd-dev-"*.raw "$AVOCADO_PREFIX/output/extensions/avocado-ext-sshd-dev-"*.kab; do [ -e "$_f" ] && printf '%s ' "$(basename "$_f")"; done; echo