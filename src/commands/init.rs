...
impl InitCommand {
    ...
    fn load_config_template(target: &str) -> String {
        match target {
            "qemux86-64" => include_str!("../../configs/qemux86-64.toml").to_string(),
            "qemuarm64" => include_str!("../../configs/qemuarm64.toml").to_string(),
            "reterminal" => include_str!("../../configs/reterminal.toml").to_string(),
            "reterminal-dm" => include_str!("../../configs/reterminal-dm.toml").to_string(),
            "jetson-orin-nano-devkit-nvme" => {
                include_str!("../../configs/jetson-orin-nano-devkit-nvme.toml").to_string()
            }
            "raspberrypi4" => include_str!("../../configs/raspberrypi4.toml").to_string(),
            "raspberrypi4-64" => include_str!("../../configs/raspberrypi4-64.toml").to_string(),
            "raspberrypi5" => include_str!("../../configs/raspberrypi5.toml").to_string(),
            "icam540" => include_str!("../../configs/icam540.toml").to_string(),
            _ => {
