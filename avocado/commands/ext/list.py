...
class ExtListCommand(BaseCommand):
    """Implementation of the 'ext list' command."""
    ...
    def register_subparser(cls, subparsers):
        """Register the ext list command's subparser."""
        parser = subparsers.add_parser(
            "list",
            help="List extension names"
        )
    ...
    def execute(self, args, parser=None, unknown=None):
        ...
        extensions = list(config["ext"].keys())
