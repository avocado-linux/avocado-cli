...
class SdkRunCommand(BaseCommand):
    ...
    def register_subparser(cls, subparsers):
        ...
        run_parser = subparsers.add_parser(
            "run", help="Run commands or interactive shell in SDK container")
    ...
    def _load_config(self, config_path):
        ...
        try:
            ...
            print(f"Error: Config file not found at {
                  abs_config_path}", file=sys.stderr)
            raise
        except Exception as e:
            print(f"Error loading config file {
                  abs_config_path}: {e}", file=sys.stderr)
            raise
    ...
    def execute(self, args, parser=None):
        ...
        try:
            ...
            print(f"An unexpected error occurred in 'sdk run': {
                  e}", file=sys.stderr)
            return False
