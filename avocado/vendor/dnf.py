# This file is vendored from mkosi project
# Original source: https://github.com/systemd/mkosi/blob/main/mkosi/installer/dnf.py
# Original copyright: Copyright (c) 2023 The mkosi contributors
